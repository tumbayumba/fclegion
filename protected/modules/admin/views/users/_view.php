...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('fav_club_id')); ?>:</b>
	<?php echo CHtml::encode($data->fav_club_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('fav_player_id')); ?>:</b>
	<?php echo CHtml::encode($data->fav_player_id); ?>
	<br />
	...
	<?php echo CHtml::encode($data->usergroup_id); ?>
	<br />
