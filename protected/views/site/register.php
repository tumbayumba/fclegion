...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<div class="hint"><?php echo Yii::t('user','Please enter the letters as they are shown in the image above.')?>
		<br/><?php echo Yii::t('user','Letters are not case-sensitive.');?></div>
